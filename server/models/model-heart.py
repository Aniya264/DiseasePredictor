...
plt.xlabel("Predicted Label (0: No Heart Disease, 1: Heart Disease)")
plt.ylabel("True Label (0: No Heart Disease, 1: Heart Disease)")
plt.savefig('plot/confusion_matrix_heart.png')
plt.show()

# Save the model and encoders
with open("pkl/trained_model_heart.pkl", "wb") as f:
    pickle.dump(model, f)
with open("pkl/feature_encoders_heart.pkl", "wb") as f:
    pickle.dump(label_encoders, f)
with open("pkl/top_features_heart.pkl", "wb") as f:
