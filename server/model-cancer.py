...
with open("cancer_disease_model.pkl", "wb") as f:
    pickle.dump(model, f)
with open("label_encoder2.pkl", "wb") as f:
    pickle.dump(y_encoder, f)
with open("feature_encoders2.pkl", "wb") as f:
    pickle.dump(label_encoders, f)
with open("top_features2.pkl", "wb") as f:
    pickle.dump(top_features, f)

print("Model and encoders saved as cancer_disease_model.pkl, label_encoder2.pkl, feature_encoders2.pkl, and top_features2.pkl")
